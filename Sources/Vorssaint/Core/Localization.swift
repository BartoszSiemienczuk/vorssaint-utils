...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "Borssaint: suspensão normal",
        statusActiveUntil: "Borssaint: ativo até",
        statusActiveIndefinite: "Borssaint: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o Borssaint",
        menuQuit: "Sair do Borssaint",
        menuHide: "Ocultar o Borssaint",
        ...
        notifyBatteryTitle: "Borssaint desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOff: "O Borssaint precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O Borssaint foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptSudoersInstall: "O Borssaint vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O Borssaint vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do Borssaint",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        tabMouse: "Mouse",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao Borssaint (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o Borssaint para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o Borssaint completamente",
        advancedUninstallConfirmTitle: "Desinstalar o Borssaint?",
        advancedUninstallConfirmBody: "O Borssaint vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        ...
        switcherEnable: "Substituir o ⌘Tab pelo alternador do Borssaint",
        ...
        uninstallerFDAHint: "Ative o Borssaint na lista. Se ele não aparecer, clique no + e escolha o Borssaint em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        updateNotifyTitle: "Atualização do Borssaint",
        ...
        obStart: "Abrir o Borssaint",
        obStepWelcomeTitle: "Bem-vindo ao Borssaint",
        ...
        obStepDoneBody: "O Borssaint já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O Borssaint agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o Borssaint precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",

        tabSupport: "Apoiar",
        donateHeading: "Apoie o Borssaint",
        donateMessage: "Todos os meus projetos públicos são, e sempre serão, totalmente gratuitos: sem assinatura, sem anúncios. O apoio da comunidade é a única forma de manter tudo vivo. Se o Borssaint te ajuda, um café faz diferença de verdade.",
        donateButton: "Buy me a coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        showMenuBarIcon: "Mostrar ícone na barra de menus",
        showMenuBarIconCaption: "Se o ícone do Borssaint sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o Borssaint pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela. O botão acima faz o mesmo quando você já consegue chegar aqui. Manter menos ícones na barra, ou menos métricas no Borssaint, reduz bastante a chance."
    )
}
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Borssaint: normal sleep",
        statusActiveUntil: "Borssaint: awake until",
        statusActiveIndefinite: "Borssaint: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Borssaint",
        menuQuit: "Quit Borssaint",
        menuHide: "Hide Borssaint",
        ...
        notifyBatteryTitle: "Borssaint disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOff: "Borssaint needs your password to restore the Mac's normal sleep.",
        adminPromptRecover: "Borssaint quit while the Mac's sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptSudoersInstall: "Borssaint will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Borssaint will remove the password-free closed-lid rule.",

        settingsTitle: "Borssaint Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        tabMouse: "Mouse",
        ...
        advancedResetDescription: "Removes every permission you granted Borssaint (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Borssaint to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Borssaint completely",
        advancedUninstallConfirmTitle: "Uninstall Borssaint?",
        advancedUninstallConfirmBody: "Borssaint will clear its permissions, remove its preferences and move to the Trash, then quit. This can't be undone from the app, but it stays in the Trash until you empty it.",
        ...
        switcherEnable: "Replace ⌘Tab with the Borssaint switcher",
        ...
        uninstallerFDAHint: "Turn Borssaint on in the list. If it isn't there, click + and pick Borssaint from Applications. Access only applies after you reopen the app.",
        ...
        updateNotifyTitle: "Borssaint update",
        ...
        obStart: "Open Borssaint",
        obStepWelcomeTitle: "Welcome to Borssaint",
        ...
        obStepDoneBody: "Borssaint is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Borssaint now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Borssaint needs Accessibility permission. Grant it in System Settings and try again.",

        tabSupport: "Support",
        donateHeading: "Support Borssaint",
        donateMessage: "Every one of my public projects is, and always will be, completely free: no subscription, no ads. Community support is the only thing that keeps it alive. If Borssaint helps you, a coffee genuinely makes a difference.",
        donateButton: "Buy me a coffee",
        donateThanks: "Thank you for being here. 🖤",
        showMenuBarIcon: "Show menu bar icon",
        showMenuBarIconCaption: "If Borssaint's icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Borssaint from Applications or Spotlight: that rebuilds the icon and, if it's still hidden, opens this window. The button above does the same when you can already get here. Keeping fewer menu bar icons, or fewer Borssaint metrics, makes it far less likely."
    )
}
