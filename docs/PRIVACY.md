...
Borssaint is built to run on your Mac and nowhere else. It is put together so your data has no reason to leave the machine in the first place.
...
- **No telemetry.** Borssaint gathers no usage stats, no crash reports, no device identifiers and no diagnostics.
...
Everything Borssaint shows you, from the CPU and memory load to the temperatures, the battery details, the network rates, the window list, per app volume and the files on the Shelf, is read locally through native macOS APIs and shown to you right there. None of it is sent anywhere, logged remotely or shared.
...
This page describes how the current version of Borssaint behaves. If the app's behavior around privacy ever changes, this page changes with it.

## Questions

If anything here is unclear, open a question in [GitHub issues](https://github.com/BartoszSiemienczuk/vorssaint-utils/issues), or have a look at [support](../SUPPORT.md).
